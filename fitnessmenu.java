...
public class Fitnessmenu extends JFrame implements ActionListener
{
   ...
   private JLabel Manual = new JLabel("Manual", JLabel.CENTER);
	...
	private String Change_UserSelect1="";
	private String Change_UserRun1="";
		...
		for(int i=0;i<5;i++)
		{
			if (e.getSource() == btn1[i])
			{
				...
				if(i==0){
					...
					MyJFrame f= new MyJFrame(Change_UserSelect1, Change_UserRun1);}
				else if(i==4){
			...
			if (e.getSource() == btn2[i])
			{
				...
				if(i==0){
					...
					MyJFrame f= new MyJFrame(Change_UserSelect2, Change_UserRun2);}
				else if(i==4){
			...
			if (e.getSource() == btn3[i])
			{
				...
				if(i==0){
					...
					MyJFrame f= new MyJFrame(Change_UserSelect3, Change_UserRun3);}
				else if(i==4){
			...
			if (e.getSource() == btn4[i])
			{
				...
				if(i==0){
					...
					MyJFrame f= new MyJFrame(Change_UserSelect4, Change_UserRun4);}
				else if(i==4){
			...
			if (e.getSource() == btn5[i])
			{
				...
				if(i==0){
					...
					MyJFrame f= new MyJFrame(Change_UserSelect5, Change_UserRun5);}
				else if(i==4){
